        ...
        <div className='whatweDoContainer py-4 md:py-8'> 
            ...
            <div className='flex flex-col mt-4 md:flex-row'>
                <div className='flex flex-col items-center p-2 m-2'>
                    <img src={getImagePath('home/webscrapping.svg')} className='h-48'/>
                ...
                <div className='flex flex-col items-center p-2 m-2'>
                <img src={getImagePath('home/ds_genai.svg')} className='h-48'/>
                ...
                <div className='flex flex-col items-center p-2 m-2'>
                <img src={getImagePath('home/nlp.svg')} className='h-48'/>

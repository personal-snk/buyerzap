    ...
    return(
        <>
            ...
            <div className="for_business_page">
                <div className='hidden breadcrum px-10 pb-5 md:pb-10 md:pt-4 md:px-24'>Home / For Business (B2B)</div>
                <div className='header_section px-10 py-20 md:p-24'>
                    <h2 className='flex flex-[1_1_10%] text-xl md:w-[55%] justify-center md:justify-start md:text-5xl font-normal'>Powered by Buyer experience & Generative AI technology</h2>
                    <button className="px-4 py-2 my-4 md:px-4 md:py-2 md:my-8 font-medium text-sm md:text-lg rounded-[30px] bg-[#00037C] text-white hover:opacity-75">Schedule a call</button>
                </div>
            </div>
            <div className='business_casecontainer'>
                <div className='px-10 md:px-16 md:pt-10'>
                    <h2 className='heading_reports text-2xl md:text-5xl md:font-medium'>AI generated reports</h2>
                </div>
            ...
            <div className='business_casecontainer'>
                <div className='px-10 md:px-16 md:pt-10'>
                    <h2 className='heading_reports text-2xl md:text-5xl md:font-medium'>AI-Related services</h2>
                </div>
                <div className='flex analysis_container'>
                    <div className='analysis_card'>
                        <img src={senti}/>
